...
public interface ControllerInterface {
     ...
     * @throws Exception
     */
    DoorStatus enterPin(String pin) throws Exception, InvalidPinException, TooManyAttemptsException;
     ...
     * @throws Exception
     */
    void addTenant(String pin, String name) throws Exception, TenantAlreadyExistsException;
     ...
     * @throws Exception
     */
    void removeTenant(String name) throws Exception, TenantNotFoundException;
}
